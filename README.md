...
- Implemented **CORS (Cross-Origin Resource Sharing)** to enable secure communication between frontend and backend  
- Used **JWT authentication** for protecting routes and user sessions  
- Applied **role-based access control** (User / Service Provider)  
- Ensured secure API handling with proper request validation and error handling  
